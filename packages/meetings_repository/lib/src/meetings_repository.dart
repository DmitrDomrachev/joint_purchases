...
/// A repository that handles meeting related requests.
/// {@endtemplate}
class MeetingsRepository {
  ...
  Future<void> saveMeetings(Meeting meeting) =>
      _meetingsApi.saveMeeting(meeting);

  /// Deletes the meeting with the given id.
  ///
  /// If no meeting with the given id exists, a [MeetingNotFoundException] error
  /// is thrown.
